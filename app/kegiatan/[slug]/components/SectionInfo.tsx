...
export default function SectionInfo({ data }: SectionInfoProps) {
  ...
  const tabs = [
    ...
    {
      href: "/kegiatan/mahakam-heroes",
      label: "Mahakam Heroes",
    },
  ];
    ...
    <>
      <section className="bg-gold py-14 relative overflow-hidden">
        ...
        <div className="w-full max-w-[1400px] px-6 mx-auto">
          ...
          {/* Content */}
          <div className="max-w-[1015px] mx-auto text-black font-jakarta text-base leading-7 mb-6">
      ...
      <section className="pt-10 bg-[#F7F7F7]">
        <YoutubeEmbed videoId="jUSIMie57u0" />
